<%@ Page Title="Home Page" Language="C#" AutoEventWireup="true" CodeBehind="member_data.aspx.cs" Inherits="WebApplication5.login" %>
...
<body id="body" data-spy="scroll" data-target=".header">
                    ...
                    <div class="collapse navbar-collapse nav-collapse">
                        <div class="menu-container">
                            <ul class="nav navbar-nav navbar-nav-right">
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="login"><asp:Label ID="username" runat="server" Text="訪客" ForeColor="#FFCC00"></asp:Label></a></li>
    ...
    <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img class="img-responsive" src="img/1920x1080/Geforce-GTX.jpg" alt="Slider Image" draggable="false">
                        ...
                        <div class="carousel-centered">
                            <div class="margin-b-40">
                               <form id="form1" runat="server">  
                                    <table border="1">
                                        <tr>
                                            <th style="background-color:aquamarine;color:brown">123</th>
                                            <th>456</th>
                                        </tr>
