                    ...
                    <div class="collapse navbar-collapse nav-collapse">
                        ...
                        <div class="menu-container">
                            <ul class="nav navbar-nav navbar-nav-right" runat="server">
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="member_data"><asp:Label ID="username" runat="server" Text="訪客" ForeColor="#FFCC00"></asp:Label></a></li>
                          ...
                          <!--<span style="position:absolute;left:50%;top:50%">-->
                                <table border="1" style="font-size:18px;font-family:serif" >
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:Label ID="final_total_price_count" runat="server" Width="1000px" Font-Size="30px" ForeColor="Black" style="text-align:center">0</asp:Label></td>
