                    ...
                    <div class="collapse navbar-collapse nav-collapse">
                        <div class="menu-container">
                            <ul class="nav navbar-nav navbar-nav-right">
								...
								<li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="shopping"><asp:Label class="nav-item-child nav-item-hover" ID="Label5" runat="server" Text="購物籃"></asp:Label></a></li>
                        ...
                        <div class="carousel-centered">
                            <div class="margin-b-40">
                               <form id="form1" runat="server">
                                    ...
                                    <asp:TextBox ID="TextBox7" runat="server" TextMode="Password"></asp:TextBox><font color="#fff">確認密碼</font><br />
